...
exports.createStore = async (req, res) => {
  ...
  req.flash('success', `Successfully Saved <strong>${store.name}</strong>. Care to leave a review?`);
...
exports.getStoresBySlug = async (req, res) => {
...
exports.getHearts = async (req, res) => {
  ...
  res.render('stores', { title: 'Favorites', stores });
};
